...
const templates: Tpl[] = [
  ...
  },
  {
    ...
    word: "Étoile",
    name: "Étoile",
    desc: "Michelin-star fine dining in the Gordon Ramsay mould. Cinematic charcoal and gold, an elegant roman serif, accolades, and a seven-course tasting menu.",
    traits: ["Charcoal + Gold", "Marcellus serif", "Two Michelin Stars"],
    bg: "radial-gradient(120% 120% at 50% 12%, #1d1914, #0c0c0d)",
    wordColor: "#b6975c",
    accent: "#b6975c",
    wordFont: "var(--font-cormorant), serif",
  },
